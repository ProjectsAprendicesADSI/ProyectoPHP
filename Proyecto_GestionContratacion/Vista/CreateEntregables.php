                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="collapse2" class="body">
                                    ...
                                    <form class="form-horizontal" id="block-validate"  enctype="multipart/form-data" action="../Controlador/EntregableController.php?action=crear" method="POST">


                                        <div class="form-group">
                                            <label class="control-label col-lg-4">Actividad de entrega</label>
                                             <div class="col-lg-4">
                                                 <textarea name="Entregables_Actividad" required id="Entregables_Actividad" class="form-control" rows="10" style="height: 100px;width: 330px;position: static "  ></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=" col-lg-4">
                                                <input required class="validate[required,custom[date]] form-control" type="date"
                                                       min="2016/01/01"  max="2020/01/01"    data-date-format="aaaa/mm/dd" name="Fecha_Cumplimiento" id="Fecha_Cumplimiento"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=" col-lg-4">
                                                <input required class="validate[required,custom[date]] form-control" type="date"
                                                       min="2016/01/01"  max="2020/01/01"    data-date-format="aaaa/mm/dd" name="Fecha_Entrega" id="Fecha_Entrega"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=" col-lg-4">
                                                <input required placeholder="" class="validate[required,custom[number]] form-control" type="number"
                                                     minlength="1"  name="Porcentaje_Entregable" id="Porcentaje_Entregable"/>
                                        ...
                                        <div class="form-group" name="Contratos" id="Contatos">
                                            ...
                                            <div class="col-lg-4">
                                                <?php echo LicitacionController::selectEmpresaContrato(); ?>
                                            </div>
                                        </div>
