        ...
        <div id="login" class="tab-pane active">
            <form  data-toggle="validator" role="form" id="frmLogin" name="frmLogin" >
                <p class="text-muted text-center">
                    Ingrese su correo electronico asociado al usuario
                </p>
                <input type="email" id="correo" name="correo" placeholder="Correo" class="form-control top">
            ...
            $('#frmLogin').on('submit', function (e) {
                if (!e.isDefaultPrevented()) {
                    ...
                    $.ajax({
                        ...
                        url         : '../Controlador/PersonaController.php?action=recordarcontrasena', // Ruta del envio
                        ...
                        .done(function(data) {
                            //console.log(data);
                            if (data == true){
                                window.location.href = "recordarcontrasena.php";
                            }else{
                                $('#results').html(data);
                            }
                        });
