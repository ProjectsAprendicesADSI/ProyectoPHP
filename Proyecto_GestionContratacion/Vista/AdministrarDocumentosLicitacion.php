...
<head>
    ...
    <title>Administrar documentos Licitacion</title>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="box">
                                                <header>
                                                    ...
                                                    <h5>Administrar Documentos Licitacion</h5>
                                                </header>
                                                <div id="collapse4" class="body">
                                                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                                        <thead>
                                                        <tr>
                                                            <th hidden >idDocumentos</th>
                                                            <th>Nombre</th>
                                                            <th>Descripcion</th>
                                                        ...
                                                        <?php echo DocumentosController:: traersolodocumentos($DataLicitacion->getIdLicitacion()); ?>
