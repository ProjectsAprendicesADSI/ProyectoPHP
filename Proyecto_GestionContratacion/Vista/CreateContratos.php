                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="collapse2" class="body">
                                    ...
                                    <form class="form-horizontal" id="block-validate"  enctype="multipart/form-data" action="../Controlador/ContratosController.php?action=crear" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" placeholder="Regimen De Contratacion" required class="validate[required] form-control" name="RC" id="RC">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <textarea required type="text" placeholder="Descripcion Objeto Contratar" class="validate[required] form-control" name="Descripcion_Objeto_Contratar" id="Descripcion_Objeto_Contratar"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=" col-lg-4">
                                                <input required class="validate[required,custom[date]] form-control" type="date"
                                                      min="2016/01/01"  max="2020/01/01" data-date-format="aaaa/mm/dd" name="Fecha_Hora_Apertura_Proceso" id="Fecha_Hora_Apertura_Proceso"/>
                                            </div>
                                        </div>
