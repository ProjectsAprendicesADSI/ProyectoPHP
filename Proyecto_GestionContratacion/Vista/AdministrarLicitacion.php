...
<head>
    ...
    <title>Administrar Licitacion</title>
                                ...
                                <div class="col-lg-12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>Administrar Licitacion</h5>
                                        </header>
                                        <div id="collapse4" class="body">
                                            <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                                <thead>
                                                <tr>
                                                    <th hidden >idLicitacion</th>
                                                    <th>Fecha de firma contrato</th>
                                                    <th>Ejecucion de Contrato</th>
                                                    <th>Contrato Nª</th>
                                                ...
                                                <?php echo LicitacionController::tablaLicitacion(); ?>
                                            </table>
                                        </div>
                                    </div>
                                </div>
