                                                ...
                                                <div class="box">
                                                    ...
                                                    <div id="collapse2" class="body">
                                                        ...
                                                        <?php if(!empty($_GET['respuesta'])){ ?>
                                                            ...
                                                            <?php } ?>
                                                        <?php } ?>
                                                        <form class="form-horizontal" id="popup-validation"  enctype="multipart/form-data" action="../Controlador/PersonaController.php?action=CambiarFoto&id='<?= $_SESSION['DataPersona']['idPersona']; ?>'" method="POST">
                                                        <div class="form-group">
                                                        <label class="control-label col-lg-4">Cambiar Foto</label>
                                                        <div class="col-lg-8">
                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
                                                                    <img src="<?=  $_SESSION['DataPersona']['Foto']; ?>" alt="">
                                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class=" col-lg-4">
                                                            <input  placeholder="Documento " value="<?= $_SESSION['DataPersona']['Documento']; ?>" required class="validate[required] form-control" type="number" name="Documento" id="Documento"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-lg-4">N° id</label>
                                                        <div class=" col-lg-4">
                                                            <input  placeholder="Documento " value="<?= $_SESSION['DataPersona']['idPersona']; ?>" required class="validate[required] form-control" type="number" name="id" id="id"/>
                                                        </div>
                                                    </div>
