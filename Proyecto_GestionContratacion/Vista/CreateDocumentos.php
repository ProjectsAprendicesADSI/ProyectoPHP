                    ...
                    <div class="col-lg-12">
                        <div class="box">
                            ...
                            <div id="collapse2" class="body">
                                ...
                                <form class="form-horizontal" id="block-validate" enctype="multipart/form-data"  action="../Controlador/DocumentosController.php?action=crear" method="POST"    >
                                    ...
                                    <div id="Licitacion" name="Licitacion" class="form-group" >
